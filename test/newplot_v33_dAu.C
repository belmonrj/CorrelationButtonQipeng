...
void arguments(int indexA, int indexB, int indexC, const char* name)
{
  ...
  tge_c3_raw->Draw("ap");
  if ( verbose ) c1->Print(Form("PlotFigs/syh_dAu_c3_%s_raw.png",name));
  ...
  tge_v3_raw->Draw("ap");
  if ( verbose ) c1->Print(Form("PlotFigs/syh_dAu_v3_%s_raw.png",name));
  ...
  tge_c3_subA->Draw("ap");
  if ( verbose ) c1->Print(Form("PlotFigs/syh_dAu_c3_%s_subA.png",name));
  ...
  tge_v3_subA->Draw("ap");
  if ( verbose ) c1->Print(Form("PlotFigs/syh_dAu_v3_%s_subA.png",name));
  ...
  if ( verbose ) c1->Print(Form("PlotFigs/syh_dAu_c3_%s_subAZ.png",name));
  ...
  if ( verbose ) c1->Print(Form("PlotFigs/syh_dAu_v3_%s_subAZ.png",name));
  ...
  if ( verbose ) c1->Print(Form("PlotFigs/syh_dAu_c3_%s_subRZ.png",name));
  ...
  if ( verbose ) c1->Print(Form("PlotFigs/syh_dAu_v3_%s_subRZ.png",name));
  ...
  tge_c3_subR->Draw("ap");
  if ( verbose ) c1->Print(Form("PlotFigs/syh_dAu_c3_%s_subR.png",name));
  ...
  tge_v3_subR->Draw("ap");
  if ( verbose ) c1->Print(Form("PlotFigs/syh_dAu_v3_%s_subR.png",name));
  ...
  c1->Print(Form("PlotFigs/syh_dAu_v3_%s_sub2.png",name));
  tge_v3_subR->Draw("p");
  leg->AddEntry(tge_v3_subR,"sub v_{3} (Reference)","p");
  c1->Print(Form("PlotFigs/syh_dAu_v3_%s_sub3.png",name));
  ...
  leg->Draw();
  line->Draw();
  c1->Print(Form("PlotFigs/syh_dAu_c3_%s.png",name));
