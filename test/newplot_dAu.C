...
void arguments(int indexA, int indexB, int indexC, const char* name)
{
  ...
  // ---
  char foutname[50];
  sprintf(foutname,"DataTextFiles/data_dAu_%s.txt",name);
  ...
  tge_c2_raw->Draw("ap");
  if ( verbose ) c1->Print(Form("PlotFigs/syh_dAu_c2_%s_raw.png",name));
  ...
  tge_v2_raw->Draw("ap");
  if ( verbose ) c1->Print(Form("PlotFigs/syh_dAu_v2_%s_raw.png",name));
  ...
  tge_c2_subA->Draw("ap");
  if ( verbose ) c1->Print(Form("PlotFigs/syh_dAu_c2_%s_subA.png",name));
  ...
  tge_v2_subA->Draw("ap");
  if ( verbose ) c1->Print(Form("PlotFigs/syh_dAu_v2_%s_subA.png",name));
  ...
  if ( verbose ) c1->Print(Form("PlotFigs/syh_dAu_c2_%s_subAZ.png",name));
  ...
  if ( verbose ) c1->Print(Form("PlotFigs/syh_dAu_v2_%s_subAZ.png",name));
  ...
  if ( verbose ) c1->Print(Form("PlotFigs/syh_dAu_c2_%s_subRZ.png",name));
  ...
  if ( verbose ) c1->Print(Form("PlotFigs/syh_dAu_v2_%s_subRZ.png",name));
  ...
  tge_c2_subR->Draw("ap");
  if ( verbose ) c1->Print(Form("PlotFigs/syh_dAu_c2_%s_subR.png",name));
  ...
  tge_v2_subR->Draw("ap");
  if ( verbose ) c1->Print(Form("PlotFigs/syh_dAu_v2_%s_subR.png",name));
  ...
  line->SetLineStyle(2);
  line->Draw();
  c1->Print(Form("PlotFigs/syh_dAu_v2_%s.png",name));
  tge_v2_subA->Draw("p");
  if ( is_CNT_FVTN_FVTS ) tg_sy_CNT_FVTN_FVTS_sub->Draw("l");
  leg->AddEntry(tge_v2_subA,"sub v_{2} (ATLAS)","p");
  c1->Print(Form("PlotFigs/syh_dAu_v2_%s_sub1.png",name));
  tge_v2_subAZ->Draw("p");
  leg->AddEntry(tge_v2_subAZ,"sub v_{2} (ATLAS, ZYAM)","p");
  c1->Print(Form("PlotFigs/syh_dAu_v2_%s_sub2.png",name));
  tge_v2_subR->Draw("p");
  leg->AddEntry(tge_v2_subR,"sub v_{2} (Reference)","p");
  c1->Print(Form("PlotFigs/syh_dAu_v2_%s_sub3.png",name));
  ...
  leg->Draw();
  line->Draw();
  c1->Print(Form("PlotFigs/syh_dAu_c2_%s.png",name));
